        ...
        {mobileMenuOpen && (
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="md:hidden bg-[var(--hawk-bg-primary)] border-t border-[var(--hawk-border)] p-4">
            <div className="flex flex-col gap-2">
              ...
              <div className="py-2 px-3"><span className="text-[var(--hawk-text-tertiary)] text-xs uppercase tracking-wider mb-2 block">Idioma</span><LanguageSelectorMobile currentLocale="es" /></div>
