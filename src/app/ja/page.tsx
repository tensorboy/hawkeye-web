...
export default function HomeJA() {
  ...
  const features = [
    {
      icon: Scan,
      title: t.features.items.sees.title,
      titleZh: t.features.items.sees.titleZh,
      description: t.features.items.sees.description,
      gradient: 'from-amber-500 to-orange-600',
    },
    {
      icon: Brain,
      title: t.features.items.thinks.title,
      titleZh: t.features.items.thinks.titleZh,
      description: t.features.items.thinks.description,
      gradient: 'from-blue-500 to-cyan-500',
    },
    {
      icon: Shield,
      title: t.features.items.private.title,
      titleZh: t.features.items.private.titleZh,
    ...
    <div className="min-h-screen bg-[var(--hawk-bg-primary)]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--hawk-bg-primary)]/80 backdrop-blur-xl border-b border-[var(--hawk-border)]">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              {navItems.map((item) => (
                <Link key={item.href} href={item.href} className="text-[var(--hawk-text-secondary)] hover:text-[var(--hawk-text-primary)] transition-colors">
                  {item.label}
                </Link>
              ))}
            </div>
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <ThemeToggle />
              <Link href="https://github.com/tensorboy/hawkeye/releases" className="hawk-btn-accent text-sm">
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-[var(--hawk-bg-primary)] border-t border-[var(--hawk-border)] p-4"
          >
            <div className="flex flex-col gap-2">
              {navItems.map((item) => (
                <Link key={item.href} href={item.href} onClick={() => setMobileMenuOpen(false)} className="py-3 px-3 text-[var(--hawk-text-primary)] rounded-lg hover:bg-[var(--hawk-bg-secondary)]">
                  {item.label}
                </Link>
              ))}
              <div className="py-2 px-3">
                <span className="text-[var(--hawk-text-tertiary)] text-xs uppercase tracking-wider mb-2 block">言語</span>
                <LanguageSelectorMobile currentLocale="ja" />
              </div>
              <div className="flex items-center py-3 px-3">
                <span className="text-[var(--hawk-text-secondary)] text-sm mr-2">{t.nav.theme}</span>
                <ThemeToggle />
              </div>
            </div>
          </motion.div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--hawk-accent)]/10 text-[var(--hawk-accent)] text-sm font-medium mb-6"
          >
          ...
          <motion.h1
            ...
            className="hawk-display-xl text-[var(--hawk-text-primary)] mb-6"
          >
            {t.hero.title}<br />
            <span className="hawk-gradient-text">{t.hero.titleHighlight}</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl text-[var(--hawk-text-secondary)] mb-8 max-w-2xl mx-auto"
          >
            {t.hero.subtitle}
          </motion.p>
          ...
          >
            <Link href="https://github.com/tensorboy/hawkeye/releases" className="hawk-btn-accent inline-flex items-center justify-center gap-2">
              <Download className="w-5 h-5" />
              {t.hero.cta.download}
              <ChevronDown className="w-4 h-4" />
            </Link>
            <Link href="https://github.com/tensorboy/hawkeye" className="hawk-btn-ghost inline-flex items-center justify-center gap-2">
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center items-center gap-4 md:gap-6 mt-8 text-sm text-[var(--hawk-text-secondary)]"
          >
            ...
            <span className="flex items-center gap-1.5">
              <Check className="w-4 h-4 text-green-500" />
              {t.trustBadges.worksOffline}
            </span>
            <span className="flex items-center gap-1.5">
              <Check className="w-4 h-4 text-green-500" />
              {t.trustBadges.dataStaysLocal}
            </span>
            <span className="flex items-center gap-1.5">
              <Check className="w-4 h-4 text-green-500" />
              {t.trustBadges.openSource}
            </span>
          </motion.div>
        </div>
          ...
          <div className="bg-gradient-to-b from-[var(--hawk-bg-tertiary)] to-[var(--hawk-bg-secondary)] rounded-2xl p-1 shadow-2xl">
            <div className="bg-[var(--hawk-bg-primary)] rounded-xl overflow-hidden">
              ...
              <div className="bg-[var(--hawk-bg-secondary)] px-4 py-3 flex items-center gap-2">
                ...
                <div className="flex-1 text-center text-sm text-[var(--hawk-text-secondary)]">{t.productDemo.windowTitle}</div>
              </div>
              <div className="p-6 bg-gradient-to-br from-[var(--hawk-bg-secondary)] to-[var(--hawk-bg-primary)] min-h-[300px] flex items-center justify-center">
                <div className="grid grid-cols-3 gap-4 w-full max-w-3xl">
                  {/* Chat Panel */}
                  <div className="col-span-1 bg-[var(--hawk-bg-primary)] rounded-lg shadow-sm border border-[var(--hawk-border)] p-4">
                    <div className="text-sm font-medium text-[var(--hawk-text-primary)] mb-3">{t.productDemo.chat}</div>
                    <div className="space-y-2">
                      <div className="bg-[var(--hawk-bg-secondary)] rounded-lg p-2 text-xs text-[var(--hawk-text-secondary)]">
                        {t.productDemo.chatMessage}
                      </div>
                      <div className="bg-[var(--hawk-accent)]/10 rounded-lg p-2 text-xs text-[var(--hawk-accent)]">
                        {t.productDemo.chatResponse}
                      </div>
                    </div>
                  </div>
                  {/* Agent Cards */}
                  <div className="col-span-2 grid grid-cols-2 gap-3">
                    <div className="bg-[var(--hawk-bg-primary)] rounded-lg shadow-sm border border-[var(--hawk-border)] p-3">
                      <div className="text-xs font-medium text-green-600 mb-1">{t.productDemo.screenPerception}</div>
                      <div className="text-sm text-[var(--hawk-text-primary)]">{t.productDemo.screenStatus}</div>
                      <div className="mt-2 text-xs text-[var(--hawk-text-tertiary)]">● {t.productDemo.running}</div>
                    </div>
                    <div className="bg-[var(--hawk-bg-primary)] rounded-lg shadow-sm border border-[var(--hawk-border)] p-3">
                      <div className="text-xs font-medium text-blue-600 mb-1">{t.productDemo.fileMonitor}</div>
                      <div className="text-sm text-[var(--hawk-text-primary)]">{t.productDemo.fileStatus}</div>
                      <div className="mt-2 text-xs text-[var(--hawk-text-tertiary)]">● {t.productDemo.active}</div>
                    </div>
                    <div className="bg-[var(--hawk-bg-primary)] rounded-lg shadow-sm border border-[var(--hawk-border)] p-3">
                      <div className="text-xs font-medium text-purple-600 mb-1">{t.productDemo.clipboard}</div>
                      <div className="text-sm text-[var(--hawk-text-primary)]">{t.productDemo.clipboardStatus}</div>
                      <div className="mt-2 text-xs text-[var(--hawk-text-tertiary)]">● {t.productDemo.ready}</div>
                    </div>
                    <div className="bg-[var(--hawk-bg-primary)] rounded-lg shadow-sm border border-[var(--hawk-border)] p-3">
                      <div className="text-xs font-medium text-orange-600 mb-1">{t.productDemo.taskSuggestions}</div>
                      <div className="text-sm text-[var(--hawk-text-primary)]">{t.productDemo.taskStatus}</div>
                      <div className="mt-2 text-xs text-[var(--hawk-text-tertiary)]">● {t.productDemo.complete}</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 md:py-24 bg-[var(--hawk-bg-primary)]">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="hawk-display-md text-[var(--hawk-text-primary)] mb-4">
              {t.demo.title}
            </h2>
            <p className="text-lg text-[var(--hawk-text-secondary)] max-w-2xl mx-auto">
              {t.demo.subtitle}
            </p>
          </motion.header>
          ...
          >
            {/* Video Player */}
            <div
              className="relative aspect-video bg-gradient-to-br from-[var(--hawk-bg-secondary)] to-[var(--hawk-bg-tertiary)] rounded-2xl overflow-hidden shadow-xl flex items-center justify-center group cursor-pointer border border-[var(--hawk-border)]"
              onClick={() => {
                if (videoRef.current) {
                  if (videoPlaying) {
              ...
              {!videoPlaying && (
                <>
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="relative z-10 w-20 h-20 md:w-24 md:h-24 rounded-full bg-[var(--hawk-accent)] flex items-center justify-center shadow-2xl"
                  >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-black/50 backdrop-blur-sm rounded-full">
                      ...
                      <span className="text-white text-sm font-medium">{t.demo.playVideo}</span>
                    </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              {[
                { time: '0:00', label: t.demo.chapters.intro, seconds: 0 },
                { time: '0:03', label: t.demo.chapters.gesture, seconds: 3 },
                { time: '0:08', label: t.demo.chapters.features, seconds: 8 },
              ].map((chapter) => (
                <button
                  key={chapter.time}
                  onClick={() => {
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-[var(--hawk-bg-secondary)] border border-[var(--hawk-border)] hover:border-[var(--hawk-accent)] transition-colors group"
                >
      ...
      <section className="py-16 md:py-24 bg-[var(--hawk-bg-secondary)]">
        <div className="container mx-auto px-4">
          <motion.header
            ...
            className="text-center mb-12"
          >
            <h2 className="hawk-display-md text-[var(--hawk-text-primary)]">
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[var(--hawk-text-secondary)]">{testimonial.role}</div>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section id="features" className="py-20 px-4 bg-[var(--hawk-bg-primary)]">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="hawk-display-md text-[var(--hawk-text-primary)] mb-4">{t.features.title}</h2>
            <p className="text-lg text-[var(--hawk-text-secondary)]">{t.features.subtitle}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="hawk-card text-center"
              >
      ...
      <section id="usecases" className="py-20 px-4 bg-[var(--hawk-bg-secondary)]">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="hawk-display-md text-[var(--hawk-text-primary)] mb-4">{t.useCases.title}</h2>
            <p className="text-lg text-[var(--hawk-text-secondary)]">{t.useCases.subtitle}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => (
              <motion.div
                ...
                className="hawk-card flex items-start gap-4"
              >
                <div className="p-3 rounded-xl bg-[var(--hawk-bg-primary)]">
                  <useCase.icon className="w-6 h-6 text-[var(--hawk-accent)]" />
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="font-semibold text-[var(--hawk-text-primary)]">{useCase.title}</h3>
                    {useCase.tag && (
                      <span className="text-xs px-2 py-0.5 rounded-full bg-[var(--hawk-accent)]/10 text-[var(--hawk-accent)]">
                        {useCase.tag}
                      </span>
                    )}
                  </div>
      ...
      <section id="platforms" className="py-20 px-4 bg-[var(--hawk-bg-primary)]">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="hawk-display-md text-[var(--hawk-text-primary)] mb-4">{t.platforms.title}</h2>
            <p className="text-lg text-[var(--hawk-text-secondary)]">{t.platforms.subtitle}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {platforms.map((platform, index) => (
              ...
              >
                ...
                <span className="text-xs px-3 py-1 rounded-full bg-[var(--hawk-bg-tertiary)] text-[var(--hawk-text-tertiary)]">
                  {platform.status}
                </span>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="hawk-card p-8 md:p-12"
            >
              <div className="flex flex-col md:flex-row items-start gap-8">
                ...
                <div className="flex-1">
                  <h2 className="text-2xl md:text-3xl font-bold text-[var(--hawk-text-primary)] mb-6">
                    {t.privacy.title}
                  </h2>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--hawk-text-secondary)]">{t.privacy.items.localProcessing}</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--hawk-text-secondary)]">{t.privacy.items.ollamaSupport}</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--hawk-text-secondary)]">{t.privacy.items.optionalCloud}</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--hawk-text-secondary)]">{t.privacy.items.openSource}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-[var(--hawk-bg-primary)]">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <Link href="https://github.com/tensorboy/hawkeye/releases" className="hawk-btn-accent inline-flex items-center gap-2">
            <Download className="w-5 h-5" />
            {t.cta.button}
          </Link>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800">
            ...
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              ...
              <Link href="/en" className="text-gray-400 hover:text-white text-sm">English</Link>
